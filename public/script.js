  ...
  window.app = new window.Vue({
    ...
    methods: {
      ...
      countdownLoop() {
        ...
        if (this.distance() <= 0) {
          if (!released) {
            this.settings.music = "resources/music/lace.mp3";
            this.updateMusic();
            released = true;
          }
        } else {
      ...
      initCountDownDate() {
        ...
        if (
          ...
          if (this.settings.console === "true") {
            // Local time
            this.countDownDate = new Date("December 24, 2025 00:00:00").getTime();
          } else {
            // Global UTC
            this.countDownDate = new Date("December 24, 2025 22:00:00").getTime();
          }
        } else {
          if (this.settings.console === "true") {
            this.countDownDate = new Date("December 24, 2025 23:00:00").getTime();
          } else {
            this.countDownDate = new Date("December 24, 2025 21:00:00").getTime();
          }
        }
      ...
      async updateBackground() {
        ...
        await window
          ...
          .then((res) =>
            res.ok ? url : "resources/backgrounds/" + rand(1, 6) + ".webp"
          )
